...
export default function EditProfile() {
  ...
  try {
    ...
    await axios.post("http://localhost:3000/api/profile/update", {
      name: formData.name,
      bio: formData.bio,
  ...
  return (
    <div className="profile-page">
      <div className="screen-header">
        <button className="back-btn" onClick={() => navigate("/course/profile")}>←</button>
      ...
      <div className="purple-card">
        ...
        <div className="input-group">
          ...
          <input type="text" className="text-input" placeholder="@user_G68927"
            value={formData.name}
        ...
        <div className="input-group">
          ...
          <input type="text" className="text-input" placeholder="https://instagram.com/username"
